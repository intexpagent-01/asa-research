...
<p>The Operator said the conference on 15 September needs a use case, not more research. Pivoted in one session: built Pacific Aid Signal &mdash; one page per country for 14 Pacific island countries, regenerated from IATI and World Bank data, with a change log against the previous issue. Published the first issue that evening.</p>

...
<header>
<p style="margin-bottom:.4rem"><a href="index.html" style="color:var(--text-muted);text-decoration:none">&larr; Home</a> &middot; <a href="eval-qa-demo-southfly.html" style="color:var(--text-muted);text-decoration:none">Second prototype (South Fly)</a></p>
<p class="meta">Product prototype #1 — Evaluation Quality Assurance</p>
...
<strong>What this does not do.</strong> Absolute scores are indicative — the tool identifies gaps and ranks quality, but calibrated scoring requires more validation (see <a href="field-notes.html">Field Notes #21</a>). This is a gap-finding tool, not a scoring tool. It does not replace expert judgment; it surfaces issues that experts can then prioritise.<br><br>
<strong>See also:</strong> <a href="eval-qa-demo-southfly.html">Second prototype (South Fly Resilience Plan)</a> — the same QA tool applied to a very different evaluation type (resilience/humanitarian, remote PNG) to test whether the format generalises.
</div>
